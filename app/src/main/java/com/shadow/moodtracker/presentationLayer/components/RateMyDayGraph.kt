...
fun RateMyDayGraph(
    ...
    records: List<RateMyDayRecord> = emptyList(),
    column: Int = 7,
    row: Int = 5,
    padding: Float = 4f
) {
    ...
    val HEADER_ROWS = 1
        ...
        Canvas(modifier = Modifier
            ...
            repeat(totalCells) { index ->
                ...
                val cellSize = Size(paddedHorizontalSpace, paddedVerticalSpace)

                drawRoundRect(
                    color = if (result == null) materialTheme.surfaceContainerHigh else Color(result.mood.toColorInt()),
                    topLeft = cellTopLeft,
                    size = cellSize,
